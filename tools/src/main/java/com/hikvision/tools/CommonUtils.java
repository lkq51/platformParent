...
public class CommonUtils {
     ...
     *
     * @param timeout
     * @author zhanhongkui 2014-12-26 上午11:33:05
     */
     ...
     *
     * @param timeout
     * @author zhanhongkui 2014-12-26 上午11:33:10
     */
     ...
     *
     * @param timeout
     * @author zhanhongkui 2014-12-26 上午11:33:20
     */
     ...
     * @param input
     * @return
     * @author zhanhongkui 2015-3-3 上午11:19:04
     */
     ...
     * @param path
     * @return
     * @author zhanhongkui 2015-10-14 下午4:30:35
     */
     ...
     * @author chengqiujiang 2015-12-7 上午9:49:35
     */
    public static String[] getSparkLibJars() {
        ...
        if (null == jarFile || !jarFile.isFile() || !jarFile.getName().endsWith(".jar")) {
            LOG.error("Spark JAR file path: {} is incorrect.", jarFile.getName());
            return new String[]{};
        }
     ...
     * @param path
     * @return
     * @author chengqiujiang 2016-7-14 下午14:30:35
     */
    ...
    // 正则表达式 - SQL特殊字符列表
    public static final Pattern JAVA_CLASS = Pattern.compile("^([a-z]+\\.)*[A-Z]([0-9a-zA-Z]*)$");
    ...
    public static boolean isJavaClass(String className) {
        ...
        Matcher matcher = null;
        try {
            matcher = JAVA_CLASS.matcher(className);
        } catch (Exception e) {
            return false;
        }
        return matcher.find();
